    ...
    public static class ApplicationDbInitializer
    {
        public static void Initialize(ApplicationDbContext db, UserManager<ApplicationUser> um, RoleManager<IdentityRole> rm, bool isDevelopment, INotificationManager nm)
        {
            ...
            var logs = new List<Log>
            {
                ...
                new Log(tools[0].Id, user1.Id, now.Subtract(TimeSpan.FromDays(3)), now.Subtract(TimeSpan.FromDays(2))),
                ...
                new Log(tools[2].Id, user2.Id, now.Subtract(TimeSpan.FromDays(2)), now.Subtract(TimeSpan.FromDays(0))),
                ...
                new Log(tools[3].Id, user2.Id, now.Subtract(TimeSpan.FromDays(10)), now.Subtract(TimeSpan.FromDays(7))),
                new Log(tools[3].Id, user1.Id, now.Subtract(TimeSpan.FromDays(5)), now),
